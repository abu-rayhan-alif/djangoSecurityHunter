...
def load_settings_context(project_root: Path, settings_module: str | None) -> dict[str, Any]:
    ...
    raw_module = settings_module or os.environ.get("DJANGO_SETTINGS_MODULE")
    module = raw_module.strip() if isinstance(raw_module, str) else None
    base: dict[str, Any] = {
            ...
            if settings.configured:
                ...
                if env_module != module:
                    ...
                    base["load_error"] = (
                        ...
                        "Run djangoguard in a fresh process per project, or match "
