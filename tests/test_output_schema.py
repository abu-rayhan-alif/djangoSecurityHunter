...
from djangoguard.output import as_json, as_sarif
from djangoguard.package_meta import REPORT_JSON_SCHEMA_VERSION
...
def test_json_report_includes_schema_and_tool() -> None:
    ...
    assert data["tool"]["name"] == "djangoguard"
...
def test_sarif_is_v2_1_with_driver_and_locations() -> None:
    ...
    assert driver["name"] == "djangoguard"
